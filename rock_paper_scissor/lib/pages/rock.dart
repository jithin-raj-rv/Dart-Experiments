...
import 'package:demo_app/pages/paper.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          children: [
            Center(child: Text('ROCK            ',style: TextStyle(fontWeight: FontWeight.bold),)),
          ],
        ),
          ...
          Center(
            child: GestureDetector(
              ...
              child: Container(
                ...
                height: 200,
                width: 200,
                child: Center(child: Text('ROCK',style: TextStyle(fontSize: 55,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),))
                ,
              ),
            ),
          )
